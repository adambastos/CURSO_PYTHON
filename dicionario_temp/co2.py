...
for chave in niveis_co2:
    qnt_co2 = sum(niveis_co2[chave]) / len(niveis_co2[chave])
    if qnt_co2 > nivel_max:
        print('O estado do {} possui níveis altíssimos de CO2, alcançando {}' .format(chave, qnt_co2))
